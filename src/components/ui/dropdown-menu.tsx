...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:ps-8",
        "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground",
        /* Radix menus set data-highlighted on hover + focus; accent base must lose to semantic variants below */
        ...
        "data-[variant=success]:text-emerald-700 data-[variant=success]:data-[highlighted]:bg-emerald-100 data-[variant=success]:data-[highlighted]:text-emerald-750 data-[variant=success]:*:[svg]:text-emerald-700! data-[variant=success]:data-[highlighted]:*:[svg]:text-emerald-700!",
        className
      )}
      {...props}
    />
